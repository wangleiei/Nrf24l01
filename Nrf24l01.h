...
// typedef uint8_t (*NRF24L01SPIRW)(uint8_t data);
// typedef void (*NRF24L01DELAYMS)(uint32_t data);
// typedef void (*NRF24L01CSN_H)(void);
// typedef void (*NRF24L01CSN_L)(void);
// typedef void (*NRF24L01CE_H)(void);
// typedef void (*NRF24L01CE_L)(void);
// typedef uint8_t (*NRF24L01CESTA)(void);
